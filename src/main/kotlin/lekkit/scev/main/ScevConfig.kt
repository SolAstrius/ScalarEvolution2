...
object ScevConfig {
    @JvmField val SPEC: ModConfigSpec
    @JvmField val JIT: ModConfigSpec.BooleanValue
    @JvmField val JIT_CACHE_MB: ModConfigSpec.IntValue
    @JvmField val FAT_MODELS: ModConfigSpec.BooleanValue
    ...
    @JvmField val GC_CREATION_GRACE_MINUTES: ModConfigSpec.IntValue
    @JvmField val GC_SWEEP_ENABLED: ModConfigSpec.BooleanValue
    @JvmField val GC_SWEEP_INTERVAL_HOURS: ModConfigSpec.IntValue
    @JvmField val GC_SWEEP_RETENTION_DAYS: ModConfigSpec.IntValue
